class SolutionsController < ApplicationController
  ...
  private
    ...
    def solution_params
      params.require(:solution).permit(:title, :description, :demoer_name, :front_page, :product_id, :plan_id, :is_creator, :get_it_url, comment_threads_attributes: [:user_id, :body],
